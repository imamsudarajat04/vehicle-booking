    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex align-items-center">
          <h5 class="card-title mb-0 flex-grow-1">Create Booking</h5>
          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control" name="usage_start" id="usage_start" value="{!! old('usage_start') !!}">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control" name="usage_end" id="usage_end" value="{!! old('usage_end') !!}">
            ...
            <div class="d-grid gap-2">
              <button class="btn btn-primary" type="submit"><i class="bx bx-plus-medical"></i> Insert Booking</button>
            </div>
          </div>
        </form>
      </div>
